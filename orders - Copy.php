...
$customer_id = isset($_POST['customer_id']) && !empty($_POST['customer_id']) ? sanitize($_POST['customer_id']) : 'NULL';
        ...
        try {
            // Insert order
"INSERT INTO orders (customer_id, customer_type, due_date, notes, user_id, order_status, payment_status) 
...
<select id="customer_type" name="customer_type">
                        ...
                        <input type="text" id="customer_phone" name="customer_phone" placeholder="Phone (optional)">
                    </div>
